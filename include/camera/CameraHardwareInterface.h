...
public:
    ...
    virtual sp<IMemoryHeap>         getRawHeap() const = 0; // 0x0C
     ...
     */
    virtual status_t    getBufferInfo(sp<IMemory>& Frame, size_t *alignedSize) = 0; // 0x24
#endif

    /** Unknown filler */
    virtual void filler1() = 0; // 0x64

    /**
     * Only used if overlays are used for camera preview.
     */
    virtual bool         useOverlay() {return false;} // 0x2C
    virtual status_t     setOverlay(const sp<Overlay> &overlay) {return BAD_VALUE;} // 0x30

    /**
     * Stop a previously started preview.
     */
    virtual void        stopPreview() = 0; // 0x34

    /**
     * Returns true if preview is enabled.
     */
    virtual bool        previewEnabled() = 0; // 0x38
     ...
     */
    virtual status_t    startRecording() = 0; // 0x3C

    /**
     * Stop a previously started recording.
     */
    virtual void        stopRecording() = 0; // 0x40

    /**
     * Returns true if recording is enabled.
     */
    virtual bool        recordingEnabled() = 0; // 0x44

    /**
     * Release a record frame previously returned by CAMERA_MSG_VIDEO_FRAME.
     */
    virtual void        releaseRecordingFrame(const sp<IMemory>& mem) = 0; // 0x48
     ...
     */
    virtual status_t    autoFocus() = 0; // 0x4C
     ...
     */
    virtual status_t    cancelAutoFocus() = 0; // 0x50

    /**
     * Take a picture.
     */
    virtual status_t    takePicture() = 0; // 0x54

    /**
     * Cancel a picture that was started with takePicture.  Calling this
     * method when no picture is being taken is a no-op.
     */
    virtual status_t    cancelPicture() = 0; // 0x58

    /**
     * Set the camera parameters. This returns BAD_VALUE if any parameter is
     * invalid or not supported. */
    virtual status_t    setParameters(const CameraParameters& params) = 0; // 0x5C

    /** Return the camera parameters. */
    virtual CameraParameters  getParameters() const = 0; // 0x60

    /** Unknown filler */
    virtual void filler2() = 0; // 0x64

    /**
     * Send command to camera driver.
     */
    virtual status_t sendCommand(int32_t cmd, int32_t arg1, int32_t arg2) = 0; // 0x68

    /**
     * Release the hardware resources owned by this object.  Note that this is
     * *not* done in the destructor.
     */
    virtual void release() = 0; // 0x6C

    /**
     * Dump state of the camera hardware
     */
    virtual status_t dump(int fd, const Vector<String16>& args) const = 0; // 0x70
